        ...
        async void OnClickToken(Object sender, EventArgs e)
        {
            ...
            switch (labelId) {
                ...
                case "metadata1EntryBox":
                    promptInput = await DisplayPromptAsync("Metadata1", "Enter the metadata 1", "OK", "CANCEL", "Metadata1", 60, Keyboard.Text);
                    vm.Metadata1 = promptInput;
                    metadata1EntryBox.Text = promptInput;
                    break;
                case "metadata2EntryBox":
                    promptInput = await DisplayPromptAsync("Metadata2", "Enter the metadata 2", "OK", "CANCEL", "Metadata2", 60, Keyboard.Text);
